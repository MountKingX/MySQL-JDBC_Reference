...
public class Department extends TableImpl<DepartmentRecord> {
    ...
    private static final long serialVersionUID = -1359882552;

    /**
     * The reference instance of <code>testdbtest.department</code>
     */
    ...
    /**
     * The column <code>testdbtest.department.id</code>.
     */
    ...
    /**
     * The column <code>testdbtest.department.name</code>.
     */
    public final TableField<DepartmentRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(20), this, "");

    /**
     * Create a <code>testdbtest.department</code> table reference
     */
    public Department() {
    ...
    /**
     * Create an aliased <code>testdbtest.department</code> table reference
     */
